...
<body>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <div class="row mb-4" id="add_course_div">
                <div class="col-lg-12 text-center">

                    {{-- Hidden FORM div Start --}}
                    <div id="form_to_be_clone_div" hidden>
                        <form class="form" id="form_to_be_clone">
                            ...
                            <div class="row m-4">
                                ...
                                <div class="col m-1">
                                    ...
                                    <div class="mb-3 form-floating">
                                        <input type="text" class="form-control" name=""
                                            id="" placeholder="Registered Students">
                                        <label for="" class="">Registered
                                            Students</label>
                                    </div>
                                </div>
                                {{-- Form Column 1 End --}}
                                ...
                                <div class="col m-1">
                                    ...
                                    <div class="mb-3 form-floating">
                                        <input type="text" class="form-control" name=""
                                            id="" placeholder="Course Duration">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="form-floating form-floating-group flex-grow-1">
                                            <input type="file" class="form-control"
                                                name="code1" placeholder="Code 1">
                                            <label for="code1">Choose Course</label>
                                        </div>
                                    </div>
                                    {{-- Form Column 2 End --}}
                                </div>
