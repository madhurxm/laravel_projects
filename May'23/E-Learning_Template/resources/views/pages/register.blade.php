...
<body>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 ">
                    <h1 class="display-1 text-center">Register to our program</h1>
                    <h1 class="mb-4 text-center">Fill your details below</h1>
                    <p class="mb-4 text-center">Payment should be done in person</p>
                    {{-- FORM Start  --}}
                    <div class="mb-4">
                        <form class="form">
                            ...
                            <div class="row m-4">
                                ...
                                <div class="col m-1">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small id="emailHelpId" class="form-text text-muted">Help
                                            text</small>
                                    </div>
                                </div>
                                {{-- Form Column 1 End --}}
                    ...
                    {{-- FORM End  --}}
                    <a href="{{ url('/login') }}"
                        class="btn btn-primary rounded-pill py-3 px-5 text-center">Login Here</a>
                </div>
            </div>
        </div>
    </div>
